...
1. Read `.agent-runway/skills/architect/SKILL.md` — this is your workflow.
2. Read these supporting files before forming any recommendation:
   - `.agent-runway/skills/architect/decision-heuristics.md` — heuristics to defend recommendations
   - `.agent-runway/skills/architect/tradeoffs.md` — framework for framing trade-offs
   - `.agent-runway/skills/architect/antipatterns.md` — structural risks to flag
   - `.agent-runway/skills/architect/patterns.md` — pattern selection guidance
   - `.agent-runway/skills/architect/foundations.md` — core architectural principles
...
The /architect Handoff template from `.agent-runway/skills/lead/validation-templates.md` containing:
