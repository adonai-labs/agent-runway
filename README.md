...
Lite installs `@start`, `@express`, `@code-review`, `@checkpoint`, `@safety-check`, and a small rule set for engineering principles, security, and testing. It does not install slash command aliases, agents, or heavy structured delivery workflows.
